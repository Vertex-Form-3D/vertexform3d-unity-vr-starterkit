...
namespace VertexFormCore
{
    public class MultiplayerVRSynchronization : NetworkBehaviour
    {
        ...
        public override void FixedUpdateNetwork()
        {
            ...
            // Guard: skip if any required transform was destroyed (e.g. spectator camera stripped down)
            if (generalVRPlayerTransform == null || mainAvatarTransform == null || headTransform == null ||
                bodyTransform == null || leftHandTransform == null || rightHandTransform == null)
                return;
        ...
        void Update()
        {
            ...
            // Guard: skip if any required transform was destroyed
            if (generalVRPlayerTransform == null || mainAvatarTransform == null || headTransform == null ||
                bodyTransform == null || leftHandTransform == null || rightHandTransform == null)
                return;
