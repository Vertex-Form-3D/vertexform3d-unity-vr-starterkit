...
{
    private const string defaultPackageUrl = "https://storage.googleapis.com/vertexform_package_updater/WebGPUv2/version.json";
    private const string tempFileName = "downloaded_package.unitypackage";
    private const string jsonUrl = "https://storage.googleapis.com/vertexform_package_updater/WebGPUv2/version.json";
