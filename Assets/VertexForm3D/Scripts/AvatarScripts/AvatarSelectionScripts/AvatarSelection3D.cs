...
{
    public class AvatarSelection3D : MonoBehaviour
    {
        [SerializeField]
        ...
        /// </summary>
        public static AvatarSelection3D Instance;
        ...
        private void Start()
        {
            ...
            customavatarloader = FindFirstObjectByType<AvatarHolder>();
            headTransform = customavatarloader.ShadowHeadTransform;
            bodyTransform = customavatarloader.ShadowBodyTransform;

            leftHandTransform = customavatarloader.HandLeftTransform;
            rightHandTransform = customavatarloader.HandRightTransform;
            if (XRIMM == null)
            {
                XRIMM = FindFirstObjectByType<XRInputModalityManager>();
            }
        ...
        {
            customavatarloader.LeftHandVisual.enabled = customavatarloader.RightHandVisual.enabled = true;
